...
puts "Я вижу у тебя есть #{money}$ и тебе
не терпиться их проиграть? Ну что же, начнём!"
...
1000.times do
  ...
  elsif x.zero? && y.zero? && z.zero? && money >= 0
  ...
  # при нулевом счете игра заканчиваеться
  next unless money <= 0

  # rubocop:enable AsciiComments
  puts "К счастью, у Вас закончились деньги,
  и Вы больше ничего не проиграете."
  sleep 4
  exit
end
